    ...
    <tr>
      <td align="center" valign="top" class="em_aside5">
        <table align="center" width="650" border="0" cellspacing="0" cellpadding="0" class="em_main_table"
          style="width: 650px; table-layout: fixed;">
          <tr>
            <td align="center" valign="top" style="padding: 0 25px; background-color: #FBFBFB;" class="em_aside10">
              <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                ...
                <tr>
                  <td class="em_grey" align="center" valign="top" style="
                        font-family: Arial, sans-serif;
                        font-size: 16px;
                        line-height: 26px;
                        color: #434343;
                      ">
                    Below code is your account email password for wantJSON.com
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td align="center" valign="top">
                    <table width="250" style="
                          width: 250px;
                          background-color: #025373;
                          border-radius: 4px;
                        " border="0" cellspacing="0" cellpadding="0" align="center">
                      <tr>
                        <td class="em_white" height="42" align="center" valign="middle" style="
                              font-family: Arial, sans-serif;
                              font-size: 16px;
                              color: #FBFBFB;
                              font-weight: bold;
...
export default async function passwordEmail(password, email) {
  const newEmailTemplate = emailIs.replace('{{password}}', password).replace('{{email}}', email);
  const mailedData = await notification.sendEmail(email, `${password} is your Email Password from wantJSON !`, newEmailTemplate);
  return mailedData;
}
