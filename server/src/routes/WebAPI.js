...
router.delete('/payload/:id', [
    ...
    deletePayloadRules,
    validateRequest,
    payloadController.delete,
]);

router.get('/payload_deleted', [
    shouldBeLoggedIn,
    payloadController.readAllDeleted,
]);
router.delete('/payload_restore/:id', [
    shouldBeLoggedIn,
    restorePayloadRules,
    validateRequest,
    payloadController.restore,
]);
