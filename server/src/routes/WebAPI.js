...
import {
    profileUpdateRules, registerRules, loginRules, sendOTPRules,
    emailVerifyRules, resetPasswordRules, changePasswordRules,
    createPayloadRules, updatePayloadRules, deletePayloadRules,
    getOnePayloadRules, restorePayloadRules, exploreOneRules,
